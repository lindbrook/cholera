...
```{r cloud, echo = FALSE}
snowMap(add.cases = FALSE, add.pumps = FALSE, add.title = FALSE)
points(regular.cases[neighborhood.cases$`7`, ], pch = 16, col = snowColors()["p7"], cex = 0.5)
```
...
plot(regular.cases[neighborhood.cases$`7`, ], asp = 1, pch = 16, col = "lightgray", cex = 0.5)
polygon(regular.cases[pearlString(periphery.cases$`7`), ], border = "red")
```
