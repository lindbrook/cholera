...
```{r cloud, fig.width = 5, fig.height = 5, echo = FALSE}
...
```{r perimeter, fig.width = 5, fig.height = 5, echo = FALSE}
...
```{r marshall, fig.width = 5, fig.height = 5, echo = FALSE}
...
```{r hull, fig.width = 5, fig.height = 5, echo = FALSE}
plot(regular.cases[neighborhood.cases$`7`, ], asp = 1, pch = 16, col = "lightgray", cex = 0.5)
...
```{r pearl_string, fig.width = 5, fig.height = 5, echo = FALSE}
