---
title: "Duplicate and Missing Cases Notes"
author: "lindbrook"
date: "`r Sys.Date()`"
...
```{r, fig.width = 4.75, fig.height = 4.75, fig.align = "center", echo = FALSE}
...
title(main = "The Three Pairs of Duplicate Cases", cex.main = 0.9)
...
title(main = paste0("15 Noel Street:", "\n",
                    " Two (282 & 422) Rather than Three Cases"), cex.main = 0.9)
...
title(main = paste0("Geometric Interpolation: Candidate Locations for",
  "\n", "the Two Missing Cases at 40 Broad Street"), cex.main = 0.9)
...
title(main = "Broad Street Unit Distance", cex.main = 0.9)
...
title(main = "Location for One Missing Case", cex.main = 0.9)
```
...
title(main = "Location for Other Missing Case", cex.main = 0.9)
...
title(main = paste0("Duplicate Observation (209) as Substitute", "\n",
                    "for Missing Case at 15 Noel Street"), cex.main = 0.9)
