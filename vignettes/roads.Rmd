...
In 1992, Rusty Dodson and Waldo Tobler digitized the map. While the original data are no longer available.^[http://www.ncgia.ucsb.edu/pubs/snow/snow.html] Those data are preserved in Michael Friendly's _HistData_ R package. An amended version of the data, _fatalities_ in this package, is plotted below.
