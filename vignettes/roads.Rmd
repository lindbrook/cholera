...
In 1992, Rusty Dodson and Waldo Tobler digitized the map. While the original data are no longer available,^[http://www.ncgia.ucsb.edu/pubs/snow/snow.html] they are preserved in Michael Friendly's _HistData_ R package. The amended version of those data are included as the _fatalities_ data frame.

```{r, fig.width = 5.25, fig.height = 5.25, fig.align = "center", echo = FALSE, eval = FALSE}
