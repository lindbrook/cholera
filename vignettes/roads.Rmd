...
To help locate and visualize streets and road segments (including map frame segments), you can use the _streetNameViewer_() and _streetNumberViewer_() functions. Note that _streetNameViewer() uses the names in the _roads_ data set. However, the fuctions tries to corrects for case and removes extraneous spaces: streetNameViewer("Oxford Street") and streetNameViewer("oxford street")
