...
neighborhoodWalking() is computationally intensive. With default arguments (i.e., observed paths), plotting can take about 5 seconds to run on a single core of a 3.1 GHz Intel Core i5.^[With 2 physical cores and 4 logical ones, it takes about 4 seconds.]. With expected paths, plotting can takes about 40 seconds on a single core and 32 on 4 logical cores.
