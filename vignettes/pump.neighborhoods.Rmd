...
To allow users to explore the data with this approach, I wrote neighborhoodVoronoi(). It creates an R object that describes one's desired neighborhood configuration. The results can be visualized with plot(). The figure below plots the "addresses" and the Voronoi cells for the 13 pumps in the original map.

```{r, fig.width = 5.25, fig.height = 5.25, fig.align = "center", message = FALSE}
plot(neighborhoodVoronoi())
```

The figure below excludes the Carnaby and Little Marlborough Street pump (#6).
