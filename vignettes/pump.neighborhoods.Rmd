...
neighborhoodWalking() is computationally intensive. With default arguments on a single core, it takes about 2-3 minutes to run. This is due to two tasks. Frist, the the function computes the shortest walking path between a case (observed or simulated) and the pump nearest to that case. Additionally, to reduce overplotting the function also computes the minimal set of segments required to represent all the paths withiin a given neighborhood.
