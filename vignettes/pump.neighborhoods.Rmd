...
neighborhoodWalking() is computationally intensive. With default arguments (i.e., observed paths), plotting can take about 5 seconds to run on a single core of a 3.1 GHz Intel Core i5.^[With 2 physical cores (4 logical cores), it takes about 4 seconds.] With expected paths, plotting takes about 40 seconds on a single core.^[With 2 physical cores (4 logical cores), it takes about 32 seconds.]
