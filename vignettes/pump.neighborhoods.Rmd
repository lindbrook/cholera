...
The dataframe with summary results for this configuration lies below:

```{r}
summary(neighborhoodVoronoi(-6))
```

The share of addresses that fall within the Broad Street pump neighborhood increases from 57% to 66%.
...
The share of addresses that fall within the Broad Street pump neighborhood increases from 59% to 70%.
