...
To allow users to explore this method, I wrote neighborhoodVoronoi().
...
```{r, fig.width = 6, fig.height = 6, message = FALSE}
neighborhoodVoronoi(select = -6)
```

For more information about neighborhoodVoronoi(), see the documentation.
