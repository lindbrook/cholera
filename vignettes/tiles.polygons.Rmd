---
title: "deldirVertices(): Tiles, Triangles and Polygons"
author: "lindbrook"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{deldirVertices(): Tiles, Triangles and Polygons}
...
To color tiles and triangles or to count the number of points (e.g., fatalities) within each tile or triangle, we can apply `sp::point.in.polygon()` to the results of `deldirVertices()`.

## Count points within tiles and triangles
