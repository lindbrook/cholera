...
If we plot the data, we would see that, regardless of the source, the removal of the pump handle occurs after a significant decline in the number of fatalities.

## Sample code

```{r, fig.width = 5.25, fig.height = 5.25, fig.align = "center", echo = TRUE, eval = FALSE}
