...
#' streetNumberLocator("Broad Street", latlong = TRUE, zoom = -10)
#' streetNumberLocator("Broad Street", distance.unit = "yard")
#' streetNumberLocator("Broad Street", zoom = FALSE)

streetNameLocatorB <- function(street.name = "Broad Street", zoom = TRUE,
