...
#' @param segment.id Character. A vector of IDs that concatenate a street's numeric ID, a whole number between 1 and 528, and a second number to identify the segment.
#' @param zoom Logical.
...
segmentLocatorB <- function(segment.id = "216-1", zoom = TRUE, latlong = FALSE,
  ...
  text(cholera::pumps[, vars], label = paste0("p", cholera::pumps$id), pos = 1)
