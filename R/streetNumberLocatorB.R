...
#' @noRd
#' @examples
#' streetNumberLocatorB(216)
#' streetNumberLocatorB(216, zoom = -10)
#' streetNumberLocatorB(216, latlong = TRUE, zoom = -10)
#' streetNumberLocatorB(216, distance.unit = "yard")
#' streetNumberLocatorB(216, zoom = FALSE)

streetNumberLocatorB <- function(street.number = 216, zoom = TRUE,
