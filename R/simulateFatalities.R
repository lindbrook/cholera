...
simulateFatalities <- function(recompute.regular.cases = FALSE,
  ...
  orthogonal.proj <- parallel::mclapply(idx, function(i) {
    ...
    ## nearest endpoint of nearest road segment (orthogonal) ##
    ...
    ## nearest endpoint of nearest road segment (Euclidean) ##
...
# approx 97 secs; aarch64 M5
# sim <- simulateFatalities(recompute.regular.cases = TRUE, multi.core = TRUE)
