...
#' @note This function is computationally intensive. See \code{vignette("Parallel")} for details. This functions document the code that generates \code{\link{sim.walking.distance}}.
#' @export
