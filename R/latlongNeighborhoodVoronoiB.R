...
latlongNeighborhoodVoronoiB <- function(pump.select = NULL, vestry = FALSE) {
  ...
  out <- list(pump.select = pump.select, vestry = vestry,
    cells = cells, pmp = pmp, statistic.data = statistic.data)
  class(out) <- "latlongNeighborhoodVoronoiB"
  out
}

#' Plot method for latlongNeighborhoodVoronoiB()
...
plot.latlongNeighborhoodVoronoiB <- function(x, add.cases = TRUE,
...
#' Print method for latlongNeighborhoodVoronoiB().
#'
#' Parameter values for latlongNeighborhoodVoronoiB().
#' @param x An object of class "latlongNeighborhoodVoronoiB" created by \code{latlongNeighborhoodVoronoiB()}.
#' @param ... Additional arguments.
#' @return A list of argument values.
#' @export

print.latlongNeighborhoodVoronoiB <- function(x, ...) {
