...
[![GitHub\_Status\_Badge](https://img.shields.io/badge/GitHub-0.5.9.9051-red.svg)](https://github.com/lindbrook/cholera/blob/master/NEWS)
...
3.5.1 on a single core of a 2.3 GHz Intel i7, plotting observed paths to
PDF takes about 5 seconds; doing the same for expected paths takes about
28 seconds. Using the functions’ parallel implementation on 4 physical
(8 logical) cores, the times fall to about 4 and 11 seconds.
