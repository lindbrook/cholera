...
[![GitHub\_Status\_Badge](https://img.shields.io/badge/GitHub-0.2.9.9017-red.svg)](https://github.com/lindbrook/cholera/blob/master/NEWS)
...
To install the current development version (v. 0.2.9.9017) from GitHub:
