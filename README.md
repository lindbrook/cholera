...
[![GitHub\_Status\_Badge](https://img.shields.io/badge/GitHub-0.5.9.9022-red.svg)](https://github.com/lindbrook/cholera/blob/master/NEWS)
...
The notes below, which are only available online, go into greater detail about various issues and topics:
...
[Note on Duplicate and Missing Cases](https://github.com/lindbrook/cholera/blob/master/docs/duplicate.missing.cases.notes.md) documents the specifics of how I "fixed" two apparent coding errors and three misplaced case in Dodson and Tobler's data.   
