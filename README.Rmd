...
Arguably, this may be one reason why Snow added a graphical annotation to the second, lesser-known version of the map that was published in the official report on the outbreak (_Report On The Cholera Outbreak In The Parish Of St. James, Westminster, During The Autumn Of 1854_):
...
```{r voronoi, fig.width = 6, fig.height = 6, fig.align = "left", message = FALSE}
...
```{r euclidean, fig.width = 6, fig.height = 6, fig.align = "left", message = FALSE}
...
```{r walk, fig.width = 6, fig.height = 6, fig.align = "left", message = FALSE}
...
```{r walk7, fig.width = 6, fig.height = 6, fig.align = "left", message = FALSE}
...
```{r expected, fig.width = 6, fig.height = 6, fig.align = "left", message = FALSE}
plot(neighborhoodWalking(case.set = "expected"))
```

The second colors the expected area of neighborhoods using points().

```{r expected_area_points, fig.width = 6, fig.height = 6, fig.align = "left", message = FALSE}
plot(neighborhoodWalking(case.set = "expected"), type = "area.points")
```

The third colors the expected area of neighborhoods using polygon().

```{r expected_area_polygons, fig.width = 6, fig.height = 6, fig.align = "left", message = FALSE}
