...
[Computing Voronoi Diagrams with Geographic Data](https://github.com/lindbrook/cholera/blob/master/docs/notes/latlongVoronoi.md) describes my working solution for computing Voronoi diagrams with geographic data. 
