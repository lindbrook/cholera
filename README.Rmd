...
My understanding is that this is more annoying than problematic. It's fixed in 'ggplot2' in version 3.2.0. If that version is not yet on CRAN, install the development version from GitHub:
