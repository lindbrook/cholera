...
- add new mapDataRange() prototype.
...
- amend euclideanStar() for case.set = "expected".
...
- export classifierAudit() and its generic methods.
...
- add cardinalDistances().


# cholera 0.9.1.9071

- copyedit georeferencing vignette.


# cholera 0.9.1.9070

- draft georeferencing vignette.
...
- use invisible() in writeGPKG().


# cholera 0.9.1.9063

- amend GeoPackage latlong coordinates.


# cholera 0.9.1.9062

- fix title in plot.euclideanLatlong().


# cholera 0.9.1.9061

- add/set plot.snow(snow.cases = FALSE, data.summary = TRUE).
...
- exclude "Map Frame" from addRoads().
...
- add latlongOrthoAnchor().


# cholera 0.9.1.9042

- replace "addr" with "anchor".
...
- include path argument in functions in writeGPKG() loop.
...
- rename frameGPKG() to mapFrameSegmentGPKG() and add new frameGPKG().


# cholera 0.9.1.9020

- add latlongCoordinatesGPKG().
